...
_kimi_bridge = _load("kimi_bridge", _TOOLS / "kimi-bridge" / "bridge.py")
...
@pytest.fixture
def kimi():
    """The kimi-bridge module (`tools/kimi-bridge/bridge.py`)."""
    return _kimi_bridge


@pytest.fixture
def statusline_hud():
    """The statusline proxy module (`tools/cc-bridge/statusline_hud.py`)."""
    return _statusline_hud

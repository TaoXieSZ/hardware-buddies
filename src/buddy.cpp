...
// M5.Lcd for landscape clock mode (both inherit M5GFX). Coords stay
...
static const Species* SPECIES_TABLE[] = {
  &CRAB_SPECIES,  // Claude mascot — first so it's the default
...
// One-shot render to an arbitrary M5GFX surface (M5.Lcd for landscape

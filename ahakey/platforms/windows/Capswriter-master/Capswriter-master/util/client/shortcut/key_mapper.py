...
NUMPAD_KEYS = {
    ...
    VK_NUMPAD_SUBTRACT: 'numpad_subtract',  # -
    ...
    def _get_special_key_objects(cls):
        ...
        if cls._SPECIAL_KEY_OBJECTS is None:
            cls._SPECIAL_KEY_OBJECTS = {
                ...
                'numpad_subtract': keyboard.KeyCode.from_vk(VK_NUMPAD_SUBTRACT),
                ...
                # Windows 运行时明确按 VK_F18(0x81) 处理，避免和设备侧 HID 0x6D 混淆。
                'f18': keyboard.KeyCode.from_vk(VK_F18),
